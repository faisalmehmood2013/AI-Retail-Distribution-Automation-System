...
# # 1. Home Page Route: Handles the root URL (e.g., http://127.0.0.1:5000/)
# @app.route('/')
# def index():
#     """Renders the main home page template."""
#     return render_template('index.html')

# # 2. Inventory Page Route: Handles the /inventory URL (e.g., http://127.0.0.1:5000/inventory)
# @app.route('/inventory')
# def inventory():
#     """
#     Renders the inventory page (inventory.html).
    
#     In a real application, you would fetch live data here.
#     We are passing dummy data (sheet_data) for the template to render correctly.
#     """
#     # --- DUMMY DATA --- 
#     # Replace this block with your Google Sheets fetching logic when ready.
#     sheet_data = [
#         {'Product': 'Nestlé Pure Life', 'Size': '500 ml', 'Current_Stock': 2000, 'Reorder_Level': 500},
#         {'Product': 'Nestlé Pure Life', 'Size': '1500 ml', 'Current_Stock': 450, 'Reorder_Level': 1000}, # Low Stock Example
#         {'Product': 'Nestlé Pure Life', 'Size': '5 Litre', 'Current_Stock': 800, 'Reorder_Level': 200},
#         {'Product': 'Nestlé Pure Life', 'Size': '19 Litre', 'Current_Stock': 150, 'Reorder_Level': 100},
#     ]
#     # ------------------
    
#     return render_template('inventory.html', sheet_data=sheet_data)

# # --- Run the application ---
# if __name__ == '__main__':
#     # Running the app in debug mode allows for automatic reloading on code changes
#     # and provides a detailed debugger for errors.
#     app.run(debug=True)
